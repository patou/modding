...
import com.sfeir.modding.client.component.message.ValidatorConstants;

/**
 * 
 * Classe Abstraite pour créer un validateur
 * Il faut réimplémenter une des trois méthodes validate
 * @author sfeir
 */
public class Validator<V> implements ValidatorHandler<V>, HasConfig {
     ...
     * @param event évènement de validation (getValue et setValue)
     */
